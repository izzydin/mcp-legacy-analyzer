...
export class ComponentVisitor {
   ...
   */
  public static extractComponents(ast: t.File): ComponentMetadata[] {
   ...
   */
  private static isClassComponent(node: t.ClassDeclaration | t.ClassExpression): boolean {
   ...
   */
  private static returnsJSX(path: NodePath<t.FunctionDeclaration | t.FunctionExpression | t.ArrowFunctionExpression>): boolean {
    let hasJSX = false;
